...
import 'package:nfc_manager/src/nfc_manager/nfc_manager.dart' as _i6;
import 'package:nfc_manager/src/nfc_manager_ios/nfc_manager.dart' as _i7;
...
/// A class which mocks [NfcManager].
///
/// See the documentation for Mockito's code generation for more information.
class MockNfcManager extends _i1.Mock implements _i6.NfcManager {
  MockNfcManager() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i3.Future<void> startSession({
    required Set<_i6.NfcPollingOption>? pollingOptions,
    required void Function(_i6.NfcTag)? onDiscovered,
    String? alertMessageIos,
    bool? invalidateAfterFirstReadIos = true,
    void Function(_i7.NfcReaderSessionErrorIos)? onSessionErrorIos,
